...
Благодаря просторной карте автомобильная инфраструктура развита, а слоты для игроков увеличены]],
	...
	default = {
		name = 'Петроградск',
		desc = [[Петроградск= Это маленький известный город в России, появился петроградск в 1978-году, в те года это было село в котором проживало очень мало людей, вскоре в 2000-ых годах село начало расширяться и туда начали переезжать молодые пары, после 2019 года Петроградск стал полноценным городом, и там стало проживать достаточно много людей. Петроградск стал известным городом после 2022.]]

Благодаря Большой карте автомобильная инфраструктура развита, а слоты для игроков увеличены]],
	},
}
...
function test.intro(toPass)
	...
	local btnRules = window:Add 'DButton'
	btnRules:Dock(TOP)
	btnRules:DockMargin(5, 10, 5, 0)
	btnRules:SetText('Правила сервера')
	function btnRules:DoClick()
