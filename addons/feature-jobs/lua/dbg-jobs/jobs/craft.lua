...
local jewelryItems = {
	{ 7765, 'Золотое кольцо с гравировкой' },
	{ 37543, 'Золотое кольцо с алмазом' },
	{ 64344, 'Золотое кольцо с рубином' },
	{ 123999, 'Золотое кольцо с сапфиром' },
	{ 80000, 'Серебряное кольцо с сапфиром' },
	{ 76424, 'Золотой браслет с рубинами' },
	{ 83230, 'Золотое ожерелье с рубинами' },
	{ 165555, 'Серьги с алмазом и жемчужиной' },
}
