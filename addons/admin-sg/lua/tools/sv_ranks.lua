...
serverguard.ranks:AddRank("GameMaster", "Game Master", 20, Color(117, 0, 211), "icon16/award_star_bronze_1.png", {
	Permissions = {
		["Sandbox settings"] = false,
		["Set Rank"] = false,
		["Edit Ranks"] = false,
...
serverguard.ranks:AddRank("curator", "Curator", 25, Color(0, 150, 0), "icon16/award_star_silver_1.png", {
	Permissions = {
		["Sandbox settings"] = true,
		["Set Rank"] = false,
		["Edit Ranks"] = false,
